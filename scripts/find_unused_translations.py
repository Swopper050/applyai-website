...
LOCALES_PATH = REPO_ROOT / "ui" / "src" / "locales"
UI_SRC_PATH = REPO_ROOT / "ui" / "src"
LOCALE_TO_CHECK = "nl.ts"
...
def main():
    ...
    locale_file_path = LOCALES_PATH / LOCALE_TO_CHECK
    ...
    with open(REPO_ROOT / "unused_translations.json", "w", encoding="utf-8") as f:
        json.dump(results, f, indent=2)
    
    print(f"\nResults exported to {REPO_ROOT}/unused_translations.json")
